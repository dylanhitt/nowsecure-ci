...
import com.nowsecure.ci.domain.NSAutoLogger;
import com.nowsecure.ci.domain.NSAutoParameters;
...
public class Main implements NSAutoParameters, NSAutoLogger {
    ...
    private void usage(String msg) {
        ...
        System.err.println(
                "\t--file                  Required                                absolute path of mobile binary");
        System.err.println("\t--token                 Required                                API token");
        System.err.println(
                "\t--group-id              Default: \"\"                             specify group if you belong to multiple groups");
        System.err.println("\t--url                   Default: https://lab-api.nowsecure.com  url for nowsecure API");
        System.err.println(
                "\t--wait                  Default: 0                              wait for results in minutes, 0 causes no wait");
        System.err.println(
